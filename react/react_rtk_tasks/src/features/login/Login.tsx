...
import { editUsername, editPassword, toggleMode, fetchAsyncLogin, fetchAsyncRegister, selectAuthen, selectIsloginView } from './loginSlice'
...
export const Login = () => {
  ...
  const login = async () => {
    if(isLoginView) {
      ...
      const result:any = await dispatch(fetchAsyncRegister(authen))
